...
export default function AdminEnquiries({ enquiries, onUpdateStatus, onDelete, lang, t }: AdminEnquiriesProps) {
  const isBng = lang === "bn";
                    ...
                    <td className="p-4 text-center">
                      <div className="flex justify-center gap-2">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 bg-rose-50 hover:bg-rose-100 text-rose-700 font-bold text-[10px] rounded transition cursor-pointer"
                        >
                          Delete
                        </button>
                      </div>
