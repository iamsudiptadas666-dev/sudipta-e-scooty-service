...
export const translations: Record<Language, TranslationDict> = {
  bn: {
    ...
    address: "পাওয়ার হাউস রোড, কালোবাড়ির দিক, বাঘাযতীন খেলার মাঠ সংলগ্ন উত্তর পার্শ্বে, অশোকনগর, উত্তর ২৪ পরগনা।",
    addressLabel: "ঠিকানা",
    ...
    heroSubtitle: "সুদীপ্ত ই-স্কুটি সার্ভিস - আমরা অত্যন্ত যত্ন সহকারে ই-স্কুটার রিপেয়ার, ব্যাটারি সার্ভিসিং এবং ইএমআই (EMI) সুবিধায় ব্যাটারি প্রদান করি।",
    ...
    showroomTitle: "সুদীপ্ত ইভি ওয়ার্ল্ড",
    ...
    invalidPasscode: "ভুল পাসকোড! আবার চেষ্টা করুন।",
    logoutButton: "লগআউট",
    ...
    invoiceTitle: "বিল / ইনভয়েস ও রসিদ",
  ...
  en: {
    ...
    phone: "+91 9064517009",
    email: "iamsudiptadas666@gmail.com",
    address: "Power House Road Workshop, Near Baghajatin Playground (Towards Kalobari), Ashoknagar, North 24 Parganas, West Bengal – 743222, India",
    ...
    invalidPasscode: "Invalid security passcode! Please try again.",
    logoutButton: "Logout",
    ...
    invoiceTitle: "Invoice & Bill of Supply",
